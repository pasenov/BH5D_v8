...
// ********************************************************************
//
/// \file electromagnetic/BH5D/src/DetectorConstruction.cc
...
void DetectorConstruction::ConstructSDandField()
{
  ...
  //fLBox = G4LogicalVolumeStore::GetInstance()->GetVolume(fMaterial->GetName());
  ...
  G4cout << " Attaching biasing operator " << biasingForceCollision->GetName()
         << " to logical volume " << fLBox->GetName()
         << G4endl;
}
